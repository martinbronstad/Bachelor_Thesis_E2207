...
IMPORTANT: This data was taken while the microcontroller was outside of the system, which means that the data is most likely outdated.
...
Additional parameters: 10 bit ADC resolution for the documents labeled new, the others are 12 bit ADC resolution
